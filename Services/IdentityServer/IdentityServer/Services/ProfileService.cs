...
namespace IdentityServer.Services
{
    public class ProfileService : IProfileService
    {
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            claims.Add(new Claim("companyId", user.CompanyId.HasValue ? user.CompanyId.Value.ToString() : user.Id.ToString()));
            claims.Add(new Claim("companyType", user.CompanyType.ToString()));
