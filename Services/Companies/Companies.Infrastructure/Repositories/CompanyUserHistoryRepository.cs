...
{
    public class CompanyUserHistoryRepository : RepositoryBase<CompanyUserHistory>, ICompanyUserHistoryRepository
    {
        public CompanyUserHistoryRepository(CompanyContext dbContext) : base(dbContext)
        {
        }
    }
}
